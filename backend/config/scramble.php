...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API REST de ZIA Carbon Control — plataforma multitenancy de medición de huella de carbono. Autenticación via Bearer JWT (Laravel Passport); casi todos los endpoints requieren un token válido y, en varios casos, un rol específico.',
    ],
